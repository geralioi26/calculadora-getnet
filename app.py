...
# 1. IDENTIDAD (Logo en pestaña y app)
...
# --- 📥 GESTIÓN INTERNA (Compras y Stock) ---
st.sidebar.divider()
st.sidebar.write("📥 **Datos de Compra y Proveedor**")
...
# 3. CÁLCULOS DE COBRO (BNA / Getnet)
st.markdown("### 💳 Cobro")
...
if os.path.isfile(ARCHIVO_INVENTARIO):
    ...
    # Mostramos la tabla invertida (el último guardado arriba)
...
s = "‎" # Invisible para evitar azules
